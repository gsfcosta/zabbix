...
if (( $? == 0 )); then
        case $opcao in
                1) echo "fping-3.9-1.el6.rf.x86_64.rpm" > /zabbix/.config/var/fpingrpm.txt; echo "libevent-1.4.13-4.el6.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "unixODBC-2.2.14-14.el6.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; echo "ius-release-1.0-15.ius.el6.noarch.rpm" > /zabbix/.config/var/phprpm.txt; echo "epel-release-6-8.noarch.rpm" > /zabbix/.config/var/epelrpm.txt; versionzbxs6 ;;
                2) echo "fping-3.9-1.el6.rf.x86_64.rpm" > /zabbix/.config/var/fpingrpm.txt; echo "libevent-1.4.13-4.el6.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "unixODBC-2.2.14-14.el6.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; versionzbxp6 ;;
                3) versionzbxa6 ;;
                4) exit ;;
        esac
elif (( $? == 1 )); then
...
if (( $? == 0 )); then
        case $opcao in
                1) echo "fping-3.10-1.el7.rf.x86_64.rpm" > /zabbix/.config/var/fpingrpm.txt; echo "libevent-2.0.21-4.el7.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "unixODBC-2.3.1-11.el7.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; echo "ius-release-1.0-15.ius.el7.noarch.rpm" > /zabbix/.config/var/phprpm.txt; echo "epel-release-7-11.noarch.rpm" > /zabbix/.config/var/epelrpm.txt; versionzbxs7 ;;
                2) echo "fping-3.10-1.el7.rf.x86_64.rpm" > /zabbix/.config/var/fpingrpm.txt; echo "libevent-2.0.21-4.el7.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "unixODBC-2.3.1-11.el7.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; versionzbxp7 ;;
                3) versionzbxa7 ;;
                4) exit ;;
        esac
elif (( $? == 1 )); then
