...
if (( $? == 0 )); then
        case $opcao in
                1) echo "http://ftp.tu-chemnitz.de/pub/linux/dag/redhat/el6/en/x86_64/rpmforge/RPMS/fping-3.9-1.el6.rf.x86_64.rpm" > /zabbix/.config/var/fpinglink.txt; echo "fping-3.9-1.el6.rf.x86_64.rpm" > /zabbix/.config/var/fpingrpm.txt; echo "https://rpmfind.net/linux/centos/6/os/x86_64/Packages/libevent-1.4.13-4.el6.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "https://rpmfind.net/linux/centos/6/os/x86_64/Packages/unixODBC-2.2.14-14.el6.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; echo "https://dl.iuscommunity.org/pub/ius/stable/Redhat/6/x86_64/ius-release-1.0-15.ius.el6.noarch.rpm" > /zabbix/.config/var/phprpm.txt; echo "https://dl.fedoraproject.org/pub/epel/6/x86_64/Packages/e/epel-release-6-8.noarch.rpm" > /zabbix/.config/var/epelrpm.txt; versionzbxs6 ;;
...
if (( $? == 0 )); then
        case $opcao in
                1) echo "http://ftp.tu-chemnitz.de/pub/linux/dag/redhat/el7/en/x86_64/rpmforge/RPMS/fping-3.10-1.el7.rf.x86_64.rpm" > /zabbix/.config/var/fpinglink.txt; echo "fping-3.10-1.el7.rf.x86_64" > /zabbix/.config/var/fpingrpm.txt; echo "https://rpmfind.net/linux/centos/7/os/x86_64/Packages/libevent-2.0.21-4.el7.x86_64.rpm" > /zabbix/.config/var/libeventrpm.txt; echo "https://rpmfind.net/linux/centos/7/os/x86_64/Packages/unixODBC-2.3.1-11.el7.x86_64.rpm" > /zabbix/.config/var/unixodbcrpm.txt; echo "https://dl.iuscommunity.org/pub/ius/stable/Redhat/7/x86_64/ius-release-1.0-15.ius.el7.noarch.rpm" > /zabbix/.config/var/phprpm.txt; echo "https://dl.fedoraproject.org/pub/epel/7/x86_64/Packages/e/epel-release-7-11.noarch.rpm" > /zabbix/.config/var/epelrpm.txt; versionzbxs7 ;;
